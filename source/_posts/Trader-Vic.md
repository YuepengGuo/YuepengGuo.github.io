...
价值是取舍的判断标准。我们的价值观是由许多我们认为必要或想要的事物，观念与原则构成的，不能喜欢与否，它们都存在于我们的潜意识中，并排列为井然有序的结构。
...
人类的心智就像一台超级电脑，产出的质量取决于输入的资料的品质和软件的逻辑。输入的资料包括过去的知识与经验。产出取决于你如何处理数据，如何训练心智发挥作用。
